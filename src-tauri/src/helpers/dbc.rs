...
static DBC_NAME_MAP: OnceLock<HashMap<&'static str, &'static str>> = OnceLock::new();

pub fn dbc_name_map() -> &'static HashMap<&'static str, &'static str> {
    DBC_NAME_MAP.get_or_init(|| {
        HashMap::from([
